package com.joaogabriel.cronometro

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.os.SystemClock
import com.joaogabriel.cronometro.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.iniciar.setOnClickListener { iniciarCronometro() }
        binding.pausar.setOnClickListener { pausarCronometro() }
        binding.zerar.setOnClickListener { zerarCronometro() }
    }
